if [ -f "container-scan-result.txt" ]; then
    ...
    ssh -i $UBUNTU_KEYPAIR ubuntu@18.212.200.65
    ...
    docker pull 680866457108.dkr.ecr.us-east-1.amazonaws.com/libtool:latest

    # Run the container
    docker run -d -p 5000:4001 680866457108.dkr.ecr.us-east-1.amazonaws.com/libtool:latest
fi
